...
using static twitchbot.ChatRoom;
using TronBonne;
...
{
    private IList<string> msg => Game1.messages;
    private IList<Color> color => Game1.msgColor;
        ...
        while (tcpClient.Connected)
        {
            ...
            if (message != null)
            {
				if (!message.Contains("USERSTATE") && !message.Contains("ROOMSTATE"))
				{
                    ...
                    {
                        Game1.Instance.AddMessage(Username + ": " + Message, UserColor);
                    }
				}
            }
        }
